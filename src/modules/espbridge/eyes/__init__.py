...
shared eye math -- ease/smoothstep/lid_openness/rounded_rect/look). Single-use helpers live in
their own effect file. Add an effect by dropping a file in a folder + one line in its __init__
